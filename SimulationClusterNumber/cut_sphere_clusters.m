%random shape
addpath('/Users/wangying/new_work/YaoRunWen/image_alignment/cut_sphere/');  
number_shape=27;
R=340;r=60;
Rmax=R+10;
Rrag=linspace(0,Rmax,500);
Rrag=[-Rrag Rrag];
load('../Rcenter.mat')
%{
Rcenter=zeros(1,3);
...
%{
plot3(record(:,1),record(:,2),record(:,3),'.','color',[239/255,91/255,143/255]);
view(90,90);
axis([-500,500,-500,500,-500,500]);
hold on;
plot3(ind_center(:,1),ind_center(:,2),ind_center(:,3),'*','color',[239/255,91/255,143/255]);
...
save_statics=['statics-',shape,'.txt'];
